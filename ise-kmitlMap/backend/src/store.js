...
function seed() {
  return {
    ...
    users: [
      { id: "U001", email: "exec@kmitl.ac.th", password: "1234", name: "จินยอง ปาร์ค", username: "exec", role: "exec", institution: "KMITL", status: "active", createdAt: "2026-01-12" },
      { id: "U002", email: "marketing@kmitl.ac.th", password: "1234", name: "อาฮยาน จาง", username: "marketing", role: "marketing", institution: "KMITL", status: "active", createdAt: "2026-01-12" },
      { id: "U003", email: "gis@kmitl.ac.th", password: "1234", name: "ธานอส ซัง", username: "gis", role: "gis", institution: "KMITL", status: "active", createdAt: "2026-01-15" },
      { id: "U004", email: "admin@kmitl.ac.th", password: "1234", name: "แตงโม จัง", username: "admin", role: "admin", institution: "KMITL", status: "active", createdAt: "2026-01-10" },
      { id: "U005", email: "pr@kmitl.ac.th", password: "1234", name: "อาสะ คิม", username: "pr", role: "pr", institution: "KMITL", status: "active", createdAt: "2026-02-02" },
      { id: "U006", email: "registrar@kmitl.ac.th", password: "1234", name: "ฮง ไลเคน", username: "registrar", role: "registrar", institution: "KMITL", status: "active", createdAt: "2026-02-02" },
      { id: "U007", email: "student@kmitl.ac.th", password: "1234", name: "อินฟินิตี้ ไอ", username: "student", role: "user", institution: "KMITL", status: "active", createdAt: "2026-03-01" },
    ...
    feedback: [
      { id: "FB-2001", userId: "U007", userName: "อินฟินิตี้ ไอ", topic: "การใช้งานแผนที่", detail: "อยากให้ค้นหาด้วยรหัสวิชาได้", status: "new", createdAt: "2026-08-19", reply: "" },
    ...
    mapEdits: [
      { id: "ML-3001", at: "2026-08-20 14:02", actorId: "U003", actorName: "ธานอส ซัง", action: "แก้ไขขอบเขตแผนผัง", target: "ขอบเขตอาคารพระจอมเกล้าฯ (Sc8)", before: "polygon v2", after: "polygon v3" },
      { id: "ML-3002", at: "2026-08-19 09:41", actorId: "U006", actorName: "ฮง ไลเคน", action: "แก้ไขข้อมูลห้อง", target: "ห้อง 107 ชั้น 1", before: "ห้องเรียนรวม", after: "ห้องปฏิบัติการ" },
      { id: "ML-3003", at: "2026-08-17 16:20", actorId: "U005", actorName: "อาสะ คิม", action: "เพิ่มตำแหน่งกิจกรรม", target: "ISE Open House 2026", before: "-", after: "ลานหน้าอาคาร Sc8" },
    ],
    ...
    mapAssets: [
      { id: "MA-01", name: "ผังชั้น 1 อาคาร Sc8", kind: "floorplan", file: "/data/floorplans/Sc8/floor1.svg", updatedAt: "2026-08-06" },
      { id: "MA-02", name: "ผังชั้น 2 อาคาร Sc8", kind: "floorplan", file: "/data/floorplans/Sc8/floor2.svg", updatedAt: "2026-08-06" },
      { id: "MA-03", name: "ภาพอาคาร Sc8", kind: "image", file: "/data/places/sc8.png", updatedAt: "2026-07-28" },
    ],
    mapDrafts: [
      { id: "MD-01", name: "ปรับพิกัดทางเข้าอาคาร Sc8", note: "ย้ายจุดทางเข้าฝั่งเหนือ 3 เมตร", savedAt: "2026-08-22 11:15", savedBy: "ธานอส ซัง", status: "draft" },
    ],
    ...
    news: [
      { id: "NW-01", title: "ประกาศตารางสอบกลางภาค 1/2569", body: "นักศึกษาสามารถตรวจสอบตารางสอบกลางภาคได้ที่ระบบทะเบียน ตั้งแต่วันที่ประกาศเป็นต้นไป", publishAt: "2026-08-20", expireAt: "2026-09-30", published: true, author: "อาสะ คิม", createdAt: "2026-08-18" },
      { id: "NW-02", title: "เปิดรับสมัครทุนการศึกษา ประจำปี 2569", body: "เปิดรับสมัครทุนการศึกษาสำหรับนักศึกษาชั้นปีที่ 2 ขึ้นไป ยื่นเอกสารได้ที่งานกิจการนักศึกษา", publishAt: "2026-09-01", expireAt: "2026-10-15", published: true, author: "อาสะ คิม", createdAt: "2026-08-22" },
      { id: "NW-03", title: "แจ้งปิดปรับปรุงลิฟต์อาคาร Sc8", body: "ลิฟต์ฝั่งทิศเหนือปิดปรับปรุงชั่วคราว ขออภัยในความไม่สะดวก", publishAt: "2026-07-01", expireAt: "2026-07-31", published: true, author: "อาสะ คิม", createdAt: "2026-06-28" },
      { id: "NW-04", title: "ร่าง: กำหนดการปฐมนิเทศนักศึกษาใหม่", body: "อยู่ระหว่างรอยืนยันกำหนดการจากคณะ", publishAt: "", expireAt: "", published: false, author: "อาสะ คิม", createdAt: "2026-08-23" },
    ],
    ...
    events: [
      {
        ...
        tempPlaceCategoryId: "CAT-05", published: true, author: "อาสะ คิม", createdAt: "2026-08-10",
      },
      {
        ...
        tempPlaceCategoryId: "", published: true, author: "อาสะ คิม", createdAt: "2026-08-12",
      },
      {
        ...
        tempPlaceCategoryId: "", published: true, author: "อาสะ คิม", createdAt: "2026-07-20",
      },
    ],
